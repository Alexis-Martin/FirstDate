...
CREATE TABLE `users` (
  ...
  `mv_name_users` bit(1) DEFAULT b'0',
  `mv_bio_users` bit(1) DEFAULT b'0',
  `mv_birthday_users` bit(1) DEFAULT b'0',
  `mv_gender_users` bit(1) DEFAULT b'0',
  `mv_location_users` bit(1) DEFAULT b'0',
  `mv_relation_users` bit(1) DEFAULT b'0',
  `mv_interested_users` bit(1) DEFAULT b'0',
...
-- Dump completed on 2016-02-22  2:50:21
